...
Filter_Facebook.prototype.replace = function()
    {
        ...
        for (var i=0, l=xPathResult.snapshotLength; i<l; i++) {
            ...
            if (textNode.data.match(/[^A-Za-z0-9_]|^@[A-Za-z0-9_]+@facebook(\.com)?/ig) &&
               !this.findAncestor(textNode,'A')) {
               textNode.parentNode.innerHTML = textNode.parentNode.innerHTML.replace(/([^A-Za-z0-9_]|^)@([A-Za-z0-9_]+)@(facebook(\.com)?)/ig, '$1@<a href="http://facebook.com/$2">$2@$3</a>');
            }
        }
    };
